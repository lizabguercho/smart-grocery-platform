...
SHUFERSAL_PRICE_FULL_RAW_DATA_DIR = PRICE_FULL_RAW_DATA_DIR / Chain.SHUFERSAL.value
SHUFERSAL_STORES_RAW_DATA_DIR = STORES_RAW_BASE_DIR / Chain.SHUFERSAL.value
SHUFERSAL_PROMO_FULL_RAW_DATA_DIR = PROMO_FULL_RAW_BASE_DIR / Chain.SHUFERSAL.value
...
RAMI_LEVY_PRICE_FULL_RAW_DATA_DIR = PRICE_FULL_RAW_DATA_DIR / Chain.RAMI_LEVY.value
RAMI_LEVY_STORES_RAW_DATA_DIR = STORES_RAW_BASE_DIR / Chain.RAMI_LEVY.value
RAMI_LEVY_PROMO_FULL_RAW_DATA_DIR = PROMO_FULL_RAW_BASE_DIR / Chain.RAMI_LEVY.value
...
VICTORY_PRICE_FULL_RAW_DATA_DIR = PRICE_FULL_RAW_DATA_DIR / Chain.VICTORY.value
VICTORY_STORES_RAW_DATA_DIR = STORES_RAW_BASE_DIR / Chain.VICTORY.value
VICTORY_PROMO_FULL_RAW_DATA_DIR = PROMO_FULL_RAW_BASE_DIR / Chain.VICTORY.value
